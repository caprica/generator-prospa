 ...
 * before the controller mappings (by default the resource handler mappings are tried *after* the controller
 * mappings.
 *
 ...
 */
@Configuration
open class SpaWebAppConfiguration : WebMvcConfigurer {
